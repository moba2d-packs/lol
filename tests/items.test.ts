...
/** The fifty-nine, by name. Not derived from a prefix the code under test also uses. */
...
describe('the item set', () => {
  ...
  it('reaches its spells only through passive/active, and only the fifty-nine', () => {
