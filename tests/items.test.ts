...
/**
 * The shop this pack ships: a hundred and six items, sixty-two spells behind them, and the
...
/** The sixty-two, by name. Not derived from a prefix the code under test also uses. */
...
describe('the item set', () => {
  ...
  it('ships exactly the hundred and six specified, keyed by their own id', () => {
  ...
  it('reaches its spells only through passive/active, and only the sixty-two', () => {
